    ...
    <div class="global-set-from">
      ...
      <div class="global-set-content">
        ...
        <div>
          ...
          <tiny-switch v-model="appStore.navbar" @change="changenavbar"></tiny-switch>
        </div>
        ...
        <div>
          ...
          <tiny-switch v-model="appStore.menu" @change="changemenu"></tiny-switch>
        </div>
        ...
        <div>
          ...
          <tiny-switch v-model="appStore.footer" @change="changefooter"></tiny-switch>
        </div>
      </div>
