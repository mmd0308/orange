export default {
  ...
  'global.form.createdAt': '创建时间',
  'global.form.createdAt.placeholder': '请选择创建时间',
  ...
  'global.table.columns.presetFlag': '预置',
  'global.table.columns.sort': '显示顺序',
  'global.table.columns.remark': '备注',
  'global.table.columns.createdAt': '创建时间',
  'global.table.columns.updatedAt': '更新时间',
}