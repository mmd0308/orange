  ...
  <div class="preview-main">
    ...
    <div class="preview-table">
      <tiny-grid ref="grid" :fetch-data="fetchDataOption" :pager="pagerConfig">
        <tiny-grid-column field="id" :title="$t('home.roundtable.index')" width="160"></tiny-grid-column>
        <tiny-grid-column field="space" :title="$t('home.roundtable.space')" width="180"></tiny-grid-column>
        <tiny-grid-column field="pv" :title="$t('home.roundtable.pv')" width="180"></tiny-grid-column>
        <tiny-grid-column field="play" :title="$t('home.roundtable.play')" width="200"></tiny-grid-column>
      </tiny-grid>
    </div>
  </div>
</template>
