export default {
  ...
  'system.department.table.columns.name': '部门名称',


  'system.user.form.name': '用户名称',
  'system.user.form.name.placeholder': '请输入用户名称',
  'system.user.form.username': '登录账号',
  'system.user.form.username.placeholder': '请输入登录账号',
  'system.user.table.columns.avatar': '头像',
  'system.user.table.columns.name': '用户名称',
  'system.user.table.columns.username': '登录账号',
  'system.user.table.columns.email': '邮箱',
  'system.user.table.columns.sex': '性别',
  'system.user.table.columns.phone': '手机号',
