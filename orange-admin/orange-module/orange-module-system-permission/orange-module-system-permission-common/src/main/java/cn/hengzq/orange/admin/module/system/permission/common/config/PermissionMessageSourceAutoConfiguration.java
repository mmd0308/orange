package cn.hengzq.orange.admin.module.system.permission.common.config;
...
public class PermissionMessageSourceAutoConfiguration {
    ...
    public PermissionMessageSourceAutoConfiguration() {
        ...
        // 加载错误码信息
        GlobalMessageSource.getInstance().addBasenames("cn.hengzq.orange.admin.module.system.permission.common.messages");
    }
