package com.hzqing.orange.admin.starter.mybatis.config;
...
import com.hzqing.orange.admin.starter.context.constants.GlobalContextConstants;
...
@Slf4j
@AutoConfiguration
@MapperScan("com.hzqing.orange.admin.module.**.mapper")
