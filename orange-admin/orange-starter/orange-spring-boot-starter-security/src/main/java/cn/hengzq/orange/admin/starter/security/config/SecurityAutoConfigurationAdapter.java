    ...
    public SecurityFilterChain filterChain(HttpSecurity security) throws Exception {
        security
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)).authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        // 允许直接访问授权登录接口
                        .requestMatchers(HttpMethod.POST, "/system/permission/*/auth/login").permitAll()
                        // 允许直接访问的授权相关接口
                        .requestMatchers(HttpMethod.GET, "/system/permission/*/auth/password-encrypt").permitAll()
