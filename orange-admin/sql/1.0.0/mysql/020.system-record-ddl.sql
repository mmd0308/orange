-- ---------------------------------------
-- orange-module-system-record 服务依赖MySql表结构
-- ---------------------------------------
...
(
    ...
    `trace_id`           varchar(64)  DEFAULT '' COMMENT '请求追踪ID',
    `resource_id`        varchar(128) DEFAULT NULL COMMENT '操作接口ID',
    `request_url`        varchar(512) DEFAULT '' COMMENT '请求URL',
    `request_method`     varchar(8)   DEFAULT NULL COMMENT '请求方式 GET,POST,PUT,PATCH,DELETE',
    ...
    `execute_time`       bigint(20)   DEFAULT NULL COMMENT '请求耗时 单位毫秒',
