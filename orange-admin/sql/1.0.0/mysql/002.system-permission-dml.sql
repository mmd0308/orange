...
INSERT INTO sys_department (id, tenant_id, name, parent_id, ancestors, sort, created_by, created_at, updated_by, updated_at)
VALUES (@d_id, @t_id, '全公司', -1, '-1', 0, @u_id, @ts, @u_id, @ts);
COMMIT;
-- ----------------------------
...
VALUES (@u_id, @t_id, @d_id, '系统管理员', 'hengzq@yeah.net', '1', '', 'admin', '$2a$10$.pPlcDi1qZfD6RXRzGagdeuamQXIGRFuG83bKf9MEYiUxEwnvHj4S', '系统管理员', @u_id, @ts, @u_id, @ts);
COMMIT;
...
VALUES (@r_id, @t_id, '系统管理员', 'admin', 1, 0, 0, '系统管理员账号-拥有所有的权限', @u_id, @ts, @u_id, @ts);
COMMIT;
...
VALUES (@n_id, @t_id, @u_id, @r_id, @u_id, @ts, @u_id, @ts);
